...
3. **Implement.** Delegate to the `implement-plan` agent, which fans each slice
   out to an `implementer` agent. Comments minimal, state the why, evergreen —
   no ticket numbers or dates.
